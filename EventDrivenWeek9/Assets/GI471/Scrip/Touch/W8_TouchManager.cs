...
public class W8_TouchManager : MonoBehaviour
{
    ...
    public event DelegateHandleTouch OnTouchCanceled;

    private static W8_TouchManager instance;

    public static W8_TouchManager Instance
    {
        get
        {
            if(instance == null)
            {
                instance = FindObjectOfType<W8_TouchManager>();
